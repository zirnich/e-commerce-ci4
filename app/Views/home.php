...
<body>
    ...
    <section class="banner_part">
        ...
        <div class="banner_img">
            <img src="<?= base_url() ?>/template/assets2/img/banner.png" alt="#" class="img-fluid">
            <img src="<?= base_url() ?>/template/assets2/img/banner_pattern.png " alt="#" class="pattern_img img-fluid">
        </div>
    </section>
    <!-- banner part start-->
                ...
                <div class="col-lg-12">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="<?= base_url() ?>/template/assets2/img/single_product_1.png" class="img-fluid" alt="#">
                                    <img src="<?= base_url() ?>/template/assets2/img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                                </div>
                            </div>
                    ...
                    <div class="single_product_iner">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="<?= base_url() ?>/template/assets2/img/single_product_2.png" class="img-fluid" alt="#">
                                    <img src="<?= base_url() ?>/template/assets2/img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                    ...
                    <div class="single_product_iner">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="<?= base_url() ?>/template/assets2/img/single_product_3.png" class="img-fluid" alt="#">
                                    <img src="<?= base_url() ?>/template/assets2/img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
    ...
    <section class="trending_items">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        <div class="single_product_item_thumb">
                            <img src="<?= base_url() ?>/template/assets2/img/tranding_item/tranding_item_1.png" alt="#" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        <img src="<?= base_url() ?>/template/assets2/img/tranding_item/tranding_item_2.png" alt="#" class="img-fluid">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        <img src="<?= base_url() ?>/template/assets2/img/tranding_item/tranding_item_3.png" alt="#" class="img-fluid">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        <img src="<?= base_url() ?>/template/assets2/img/tranding_item/tranding_item_4.png" alt="#" class="img-fluid">
                        <h3> <a href="single-product.html">Cervical pillow for airplane
                                car office nap pillow</a> </h3>
                        <p>From $5</p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        <img src="<?= base_url() ?>/template/assets2/img/tranding_item/tranding_item_5.png" alt="#" class="img-fluid">
                        <h3> <a href="single-product.html">Foam filling cotton slow rebound pillows</a> </h3>
                        <p>From $5</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        <img src="<?= base_url() ?>/template/assets2/img/tranding_item/tranding_item_6.png" alt="#" class="img-fluid">
                        <h3> <a href="single-product.html">Memory foam filling cotton Slow rebound pillows</a> </h3>
                        <p>From $5</p>
                    </div>
                </div>
                    ...
                    <div class="client_review_slider owl-carousel">
                        <div class="single_client_review">
                            <div class="client_img">
                                <img src="<?= base_url() ?>/template/assets2/img/client.png" alt="#">
                            </div>
                        ...
                        <div class="single_client_review">
                            <div class="client_img">
                                <img src="<?= base_url() ?>/template/assets2/img/client_1.png" alt="#">
                            </div>
                            <p>"Working in conjunction with humanitarian aid agencies, we have supported programmes to help alleviate human suffering.</p>
                            <h5>- Micky Mouse</h5>
                        </div>
                        <div class="single_client_review">
                            <div class="client_img">
                                <img src="<?= base_url() ?>/template/assets2/img/client_2.png" alt="#">
                            </div>
                            <p>"Working in conjunction with humanitarian aid agencies, we have supported programmes to help alleviate human suffering.</p>
                            <h5>- Micky Mouse</h5>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?= base_url() ?>/template/assets2/img/icon/feature_icon_1.svg" alt="#">
                        <h4>Credit Card Support</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?= base_url() ?>/template/assets2/img/icon/feature_icon_2.svg" alt="#">
                        <h4>Online Order</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?= base_url() ?>/template/assets2/img/icon/feature_icon_3.svg" alt="#">
                        <h4>Free Delivery</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?= base_url() ?>/template/assets2/img/icon/feature_icon_4.svg" alt="#">
