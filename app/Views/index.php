...
<body>
	...
	<div class="page-container">
		...
		<div class="sidebar-menu">
			<div class="sidebar-header">
				<div class="logo">
						<a href="index.html"><img src="<?= base_url() ?>/template/assets/images/icon/logo.png" alt="logo"></a> -
				</div>
			</div>
			<div class="main-menu">
									...
									<div class="nofity-list">
										<a href="#" class="notify-item">
											<div class="notify-thumb">
												<img src="<?= base_url() ?>/template/assets/images/author/author-img1.jpg" alt="image">
											</div>
											<div class="notify-text">
												<p>Aglae Mayer</p>
										...
										<a href="#" class="notify-item">
											<div class="notify-thumb">
												<img src="<?= base_url() ?>/template/assets/images/author/author-img2.jpg" alt="image">
											</div>
											<div class="notify-text">
												<p>Aglae Mayer</p>
										...
										<a href="#" class="notify-item">
											<div class="notify-thumb">
												<img src="<?= base_url() ?>/template/assets/images/author/author-img3.jpg" alt="image">
											</div>
											<div class="notify-text">
												<p>Aglae Mayer</p>
										...
										<a href="#" class="notify-item">
											<div class="notify-thumb">
												<img src="<?= base_url() ?>/template/assets/images/author/author-img4.jpg" alt="image">
											</div>
											<div class="notify-text">
												<p>Aglae Mayer</p>
				...
				<div class="row align-items-center">
					...
					<div class="col-sm-6 clearfix">
						<div class="user-profile pull-right">
							<img class="avatar user-thumb" src="<?= base_url() ?>/template/assets/images/author/avatar.png" alt="avatar">
							<h4 class="user-name dropdown-toggle" data-toggle="dropdown">Fauzia <i class="fa fa-angle-down"></i></h4>
								...
								<div class="member-box">
									<div class="s-member">
										<div class="media align-items-center">
											<img src="<?= base_url() ?>/template//images/team/team-author1.jpg" class="d-block ui-w-30 rounded-circle" alt="">
									...
									<div class="s-member">
										<div class="media align-items-center">
											<img src="<?= base_url() ?>/template/assets/images/team/team-author2.jpg" class="d-block ui-w-30 rounded-circle" alt="">
											<div class="media-body ml-5">
									...
									<div class="s-member">
										<div class="media align-items-center">
											<img src="<?= base_url() ?>/template/assets/images/team/team-author3.jpg" class="d-block ui-w-30 rounded-circle" alt="">
											<div class="media-body ml-5">
									...
									<div class="s-member">
										<div class="media align-items-center">
											<img src="<?= base_url() ?>/template/assets/images/team/team-author4.jpg" class="d-block ui-w-30 rounded-circle" alt="">
											<div class="media-body ml-5">
									...
									<div class="s-member">
										<div class="media align-items-center">
											<img src="<?= base_url() ?>/template/assets/images/team/team-author5.jpg" class="d-block ui-w-30 rounded-circle" alt="">
											<div class="media-body ml-5">
	...
	<script src="<?= base_url() ?>/template/assets/js/vendor/jquery-2.2.4.min.js"></script>
	<!-- bootstrap 4 js -->
	...
	<script src="<?= base_url() ?>/template/assets/js/line-chart.js"></script>
	<!-- all bar chart activation -->
	<script src="<?= base_url() ?>/template/assets/js/bar-chart.js"></script>
	<!-- all pie chart -->
	<script src="<?= base_url() ?>/template/assets/js/pie-chart.js"></script>
	<!-- others plugins -->
